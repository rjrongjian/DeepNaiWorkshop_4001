...
namespace MyTools
{
    public class MailTool
    {
        ...
        public MailTool(string toList, string subject, string body)
        {
            this.ToList = toList;
        ...
        /// <param name="body">邮件正文</param>  
        public MailTool(string toList, string subject, bool isBodyHtml, string body)
        {
            this.ToList = toList;
            this.Subject = subject;
        ...
        /// <param name="isBodyHtml">邮件正文是否为Html格式</param>  
        /// <param name="body">邮件正文</param>  
        public MailTool(string toList, string ccList, string bccList, string subject, bool isBodyHtml, string body)
        {
            this.ToList = toList;
            this.CCList = ccList;
        ...
        public MailTool(string toList, string ccList, string bccList, string subject, bool isBodyHtml, string body, List<Attachment> attachmentList)
        {
            this.ToList = toList;
            this.CCList = ccList;
            this.BccList = bccList;
